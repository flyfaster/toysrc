...
char program1[] = "import sys;import platform; print(platform.python_version() + \" ARGV: %s\"%hasattr(sys, \"argv\"))";
char main_program[] = "import sys; sys.argv=sys.argv if hasattr(sys, \"argv\") else [\"abc\"] ; print(platform.python_version() +  \"ARGV: %d\"%id(sys.argv))";
