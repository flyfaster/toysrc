...
========================================================================
    ACTIVE TEMPLATE LIBRARY : OzSvc Project Overview
========================================================================

AppWizard has created this OzSvc project for you to use as the starting point for
...
OzSvc.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (OzSvc.h)
        GUID definitions                                (OzSvc_i.c)
        A type library                                  (OzSvc.tlb)
        Marshaling code                                 (OzSvc_p.c and dlldata.c)

OzSvc.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in OzSvc.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named OzSvc.pch and a precompiled types file named StdAfx.obj.
...
OzSvcps.vcproj
	...
	dlldata.c, OzSvc_i.c and OzSvc_p.c which are required
